...
若 `practice_work_orders=true`，由 Lesson Agent 检测并调用 WorkOrder Skill Agent；不可用时交付 Lesson 与 handoff 并明确 `WorkOrder Skill unavailable; handoff generated.`，不得由 Lesson Python subprocess 或伪造工单 DOCX。
