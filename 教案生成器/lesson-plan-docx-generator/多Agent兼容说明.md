...
2.2.2 hotfix 还要求确认后的课程信息冻结到 `confirmed_course_info`，正文 Agent 不得重写课程名称、专业、授课对象或课时；有联网能力时确认后必须先检索真实公开资料，再建立 `reference_pool`。教材、PPT、课件、案例和内部教学资源不得进入 `references`；正文不得保留机械“聚焦：xxx”等主题尾缀。
参考文献可见文本必须保留真实责任者信息：正式出版物保留作者/编者、出版社和年份；高校公开课程保留责任教师/课程团队、开课高校和课程平台/出版社，不能只写平台名称。优先混合正式出版物与高校公开课程，当前课程教材继续不得进入 `references`。
